...
// .wrangler/tmp/bundle-CncR8y/checked-fetch.js
...
// .wrangler/tmp/bundle-CncR8y/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-CncR8y/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
  ...
  async function resolveUniqueSlug(baseSlug, prefix) {
    ...
    async function getInternalList(key) {
      try {
        ...
        console.error("getInternalList parse error:", e.message);
        return [];
      }
    }
